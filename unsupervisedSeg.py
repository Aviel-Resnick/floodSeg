...
parser.add_argument('--nSuperpixels', metavar='K', default=10000, type=int, help='number of superpixels')
...
# slic
labels = segmentation.slic(im, compactness=args.compactness, n_segments=args.nSuperpixels)
