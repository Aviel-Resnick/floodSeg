...
class SelectionWindow:
    ...
    _displays = cycle(['selection', 'mask'])
    ...
    def _drawselection(self):
        ...
        self._contours = cv2.findContours(self._mask, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)[1]
        #cv2.drawContours(self._selection, self._contours, -1, color=(0, 0, 0), thickness=-1)  # highlight contours
